...
See [data and maps](standard_of_comparison_map.html).
...
gloss_example("me **ez** tü ziyodte ʕämeldan vediromo-r-um",
              "I ABL you.sg more wily come_out-AOR-1",
...
gloss_example("wacːi kj'e-ja rehã-ɬːiː muk'u-w ija **jacːu-č'i**",
              "brother two-NUM year-NM.OBL.ERG little-M COP sister.OBL-CONT",
...
```{r}
gloss_example("lu utağ **la'a-be-var** an ghala-yu",
